...
static void PrintBanner (void)
{
		Com_Printf(MSG_NORMAL,
			...
			"#######################################################################################################################\n"
			"######     #############          #######          ###############   ------------------------------------------    ####\n"
			"######     #############           #####           ###############     Quake III Protocol Open Master Server       ####\n"
			"######     ###############   #      ###      #     ###############   ------------------------------------------    ####\n"
			"######     ############# ### ##      #      ##     ###############   DPMASTER Version : %5s                      ####\n"
			"######     #############   #####           ###     ###############   Listening Port   : %5i                      ####\n"
			"######     #############     ####         ####     ###############   Maximum Servers  : 0%i                      ####\n"
			"######     #############     #####       #####     ###############   Built %s %s                    ####\n"
			"######     #############     ######     ######     ###############                                                 ####\n" 
			"######                       #######   #######     ###############   https://github.com/FlamingEnt/dpmaster        ####\n"
			"#######################################################################################################################\n\n"

			"Strating DPMaster ...\n" ,VERSION , DEFAULT_MASTER_PORT, DEFAULT_MAX_NB_SERVERS , __DATE__ , __TIME__);
		//banner_printed = true;
		SetConsoleTitle(L"Quake III Protocol DPMASTER");
}
