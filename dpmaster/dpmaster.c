	...
	if (! banner_printed)
	{
		...
		*/
		...
		Com_Printf(MSG_NORMAL,
			...
			"######                       #######   #######     ###############       Copyright 2019 ULTRAMODIFICATION          ####\n"
			"#######################################################################################################################\n\n"
			//"\n"
			...
			//"||########################################################################################################||\n"
			//"¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n"
			//"¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯             All Systems Designed & Programmed by Hoseeinpourziyaie           ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n"
			//"¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯                   For More Information Visit www.ultramod.eu                 ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n"
			//"¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯            Copyright 2019 ULTRAMODIFICATION. All rights reserved.            ¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n"
			//"¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n\n"
			//"############################################################################################################\n"
			//" - DpMaster Version                        : %s                       \n"
			//" - MasterServer Listening Port             : %i                       \n"
			//" - Maximum Number of Servers in List       : %i                       \n"
			//" - Maximum Number of Servers Per Address   : %i                       \n"		
			//"############################################################################################################\n\n"

			/*"Using Port %i as MasterServer Default Port\n"*/		
			"Strating DPMaster ...\n" ,VERSION , DEFAULT_MASTER_PORT, DEFAULT_MAX_NB_SERVERS , DEFAULT_MAX_NB_SERVERS_PER_ADDRESS );
		banner_printed = true;
		SetConsoleTitle(L"ULTRAMOD MW2 DPMASTER");
